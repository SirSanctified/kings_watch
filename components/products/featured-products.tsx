...
const FeaturedProducts = ({ products }: { products: Product[] }) => {
  return (
    <section className="flex flex-col items-center justify-start gap-4 px-4 md:px-8 lg:px-24 w-full">
      ...
      <h1 className="text-2xl md:text-4xl text-start font-bold text-gray-800 dark:text-white">
        Featured Products
      </h1>
      <Link
        href="/products"
        title="View All Products"
        className="flex-1 whitespace-nowrap text-gray-600 hover:text-yellow-600 dark:text-gray-300 transition-all duration-300 ease-linear"
      >
        See All
      </Link>
      </div>
